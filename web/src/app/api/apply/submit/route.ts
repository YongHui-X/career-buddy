import { submitSession } from "@/lib/apply/session";
...
export async function POST(req: Request) {
  ...
  const result = await submitSession(body.sessionId, body.answers || {}, body.fields || [], body.expectedCompany, body.expectedRole);
